---
title: 'Verse Interpreter'
description: 'An Interpreter written in python for the upcoming Verse programming language.'
tags: ['Python', 'Interpreter', 'Verse']
image: './banner.png'
link: 'https://github.com/Marcel-TO/Verse-Interpreter-in-Python'
startDate: '2023-03-09'
endDate: '2023-06-11'
contributors: ['me', 'christy']
---
...
- Name of the token
- Value
  ![TokenTypes](./images/tokentypes.png)
...
- First the [verse_input.py](https://github.com/Marcel-TO/Verse-Interpreter-in-Python/blob/main/modules/verse_input.py) script file: this file allows the user to manipulate the variable `text` and change its string content to the desired verse code:
...
sys.setrecursionlimit(1000000) # increases recursion limit for complex recursions
start_text # prints out the verse console header
...
- Second, using the [Verse Console](https://github.com/Marcel-TO/Verse-Interpreter-in-Python/tree/main/Executable): Here you can enter verse code like a command tool:
  ![console script](./banner.png)

- Inside the [Executable Directory](https://github.com/Marcel-TO/Verse-Interpreter-in-Python/tree/main/Executable) you find 2 executables for either Windows and MacOS. Running them opens up a command console with the running script. The usability of the .EXE is the same as the Verse Console file.

## Test Cases

The File [Verse Interpreter Test](https://github.com/Marcel-TO/Verse-Interpreter-in-Python/blob/main/modules/verse_interpreter_test.py) contains many test cases regarding the different features.
